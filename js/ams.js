...
function ams(){
    ...
    function forward(tracks) {
        ...
        container = document.getElementById( 'BypassDiv' );
        ...
        for ( var i = 0; i < MAX_POINTS-1; i++ ) {
            ...
            ams_ite = branch.ams_ite;

            //if(current_ams_ite<ams_ite) {
            //    current_ams_ite=ams_ite;
    ...
    //        return 0;
        ...
        var linematerial = new THREE.LineBasicMaterial( { color: 'rgba(255,255,255,1)', linewidth:2, transparent:false} );
...
//                .start();
    ...
    function readCSV(tracks) {
        ...
        jQuery.get('tracks/bypass_dump_tracks.t4_dump_tracks_1.csv', function(data) {
